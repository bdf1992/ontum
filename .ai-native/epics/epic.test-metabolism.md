...
**Status:** confirmed arc (bdo, 2026-06-16). The machine-readable record is
`epic.test-metabolism.json`, structured faithfully from this draft; the text
below is the author's v2 draft, homed verbatim.
