...
2. atom.branded-surface-viewer.v0 — read + live-tail branded viewer. ← IN PROGRESS (rows 1–3 green: the branded standalone window + the session list/select + transcript read & render; row 4 next: live-tail the active session as it appends).
